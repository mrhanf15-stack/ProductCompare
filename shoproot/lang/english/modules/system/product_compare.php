...
define('MODULE_PRODUCT_COMPARE_TEXT_DESCRIPTION', 'Allows customers to compare products side by side using product tags (products_tags). Session-based, works without login.');

define('MODULE_PRODUCT_COMPARE_STATUS_TITLE', 'Enable Module');
define('MODULE_PRODUCT_COMPARE_STATUS_DESC', 'Should the Product Compare module be enabled?');
